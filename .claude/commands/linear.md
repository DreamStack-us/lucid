...
### Loother-Specific: DRE- Ticket Prefix
**CRITICAL**: All Loother Linear tickets use the **DRE-** prefix (e.g., DRE-73, DRE-245, DRE-1234).

When creating tickets, naming files, or referencing tickets:
- Implementation plans: `YYYY-MM-DD-DRE-XXX-feature-name.md`
- Ticket references: "DRE-245" not "ENG-245" or generic numbers
- Branch names: Should include DRE- prefix when available
- Comments and descriptions: Always use full DRE-XXX format
...
8. **Post-creation actions:**
   - Show the created ticket URL with DRE- prefix (e.g., "Created DRE-250: Feature Name")
